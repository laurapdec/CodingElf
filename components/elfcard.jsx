...
import { bioComponents, ptComponents } from '../lib';


function ElfCard({author}) {
  return (
    <div className="bg-[#fffae2] shadow-lg rounded-lg p-8 pb-12 mb-8 w-full mx-auto  md:w-5/6  lg:w-full lg:mx-0 lg:p-4">
        ...
        <div className='text-justify px-2 mb-4   '>
            <PortableText
                value={author.bio}
