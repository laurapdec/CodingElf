    ...
    return (
      <>
        <div className='hidden md:block fixed bottom-5 right-5  rounded-full '>
            <div className='bg-red-500 my-2 rounded-full w-16 h-16 justify-center flex items-center fill-white/80 text-white/80 cursor-pointer hover:bg-red-700'><Likes likesinit={likes} size={"30px"} heartstyle={"ml-2"} slug={slug}/></div>
        ...
        <div className='fixed md:hidden bottom-5 right-1  rounded-full '>
            <div className='bg-red-500 my-2 rounded-full w-12 h-12 justify-center flex items-center fill-white/80 text-white/80 cursor-pointer hover:bg-red-700'><Likes likesinit={likes} size={"20px"} generalstyle={"flex items-center"} heartstyle={" ml-2"}  slug={slug}/></div>
            ...
            <div className='bg-gray-500 my-2 rounded-full w-12 h-12 justify-center flex items-center fill-white/80 text-white/80 cursor-pointer hover:bg-gray-700'><Github size={"20px"} styleoptions={"mx-1"}/></div>
